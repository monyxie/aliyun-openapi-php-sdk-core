...
class DescribeEndpointRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct(LocationService::PRODUCT_NAME, LocationService::VERSION, LocationService::DESCRIBE_ENDPOINT_ACTION);

        $this->queryParameters["Id"] = $id;
        $this->queryParameters["ServiceCode"] = $serviceCode;
        $this->queryParameters["Type"] = $endPointType;
        $this->setRegionId(LocationService::REGION);
