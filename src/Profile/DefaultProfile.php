...
class DefaultProfile implements IClientProfile
{
    ...
    private function __construct($regionId, $credential, $authType = self::AUTH_TYPE_RAM_AK)
    {
    ...
    public static function getRamRoleArnProfile($regionId, $accessKeyId, $accessSecret, $roleArn, $roleSessionName)
    {
        ...
        self::$profile = new DefaultProfile($regionId, $credential, DefaultProfile::AUTH_TYPE_RAM_ROLE_ARN);
        return self::$profile;
    }
    ...
    public static function getEcsRamRoleProfile($regionId, $roleName)
    {
        ...
        self::$profile = new DefaultProfile($regionId, $credential, DefaultProfile::AUTH_TYPE_ECS_RAM_ROLE);
        return self::$profile;
    }
    ...
    {
        if (self::$authType == DefaultProfile::AUTH_TYPE_RAM_ROLE_ARN) {
            return true;
        }
        return false;
    }
    ...
    {
        if (self::$authType == DefaultProfile::AUTH_TYPE_ECS_RAM_ROLE) {
            return true;
        }
        return false;
    }
