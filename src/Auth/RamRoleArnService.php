...
class RamRoleArnService
{
    ...
    const STS_DOMAIN = "sts.aliyuncs.com";
    ...
    public static $serviceDomain = RamRoleArnService::STS_DOMAIN;
    ...
    public function getSessionCredential()
    {
        if ($this->lastClearTime != null && $this->sessionCredential != null) {
            ...
            if ($elapsedTime <= RamRoleArnService::ROLE_ARN_EXPIRE_TIME * 0.8) {
    ...
    private function assumeRole()
    {
        ...
        $request = new \Aliyun\Core\Auth\AssumeRoleRequest($ramRoleArnCredential->getRoleArn(), $ramRoleArnCredential->getRoleSessionName());
